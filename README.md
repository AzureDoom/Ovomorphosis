...
![Minecraft 1.21.1](https://img.shields.io/badge/Minecraft-1.21.1-green?style=for-the-badge)
...
Ovomorphosis requires the following:
...
Ovomorphosis supports both Fabric and NeoForge for Minecraft 1.21.1.

Use the Fabric file if you are playing on Fabric.

Use the NeoForge file if you are playing on NeoForge.

Do not install both loader versions at the same time.

## Installation

1. Install Minecraft 1.21.1.
2. Install Fabric or NeoForge.
3. Download the matching version of AzureLib for your loader.
4. Download the matching version of Ovomorphosis for your loader.
...
Ovomorphosis is a multiloader mod for Minecraft 1.21.1. It is built for Fabric and NeoForge and depends on AzureLib for animated entities and related systems.

This mod should work in both singleplayer and multiplayer as long as the correct loader version and dependencies are installed.
