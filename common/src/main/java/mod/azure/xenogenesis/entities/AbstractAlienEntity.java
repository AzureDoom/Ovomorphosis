package mod.azure.xenogenesis.entities;
...
public class AbstractAlienEntity extends PathfinderMob implements WallCrawlingMob {
    ...
    @Override
    public boolean xenogenesis$isWallCrawling() {
        return this.entityData.get(DATA_WALL_CRAWLING);
    }

    @Override
    public void xenogenesis$setWallCrawling(boolean crawling) {
    ...
    @Override
    public int xenogenesis$getWallCrawlGraceTicks() {
        return wallCrawlGraceTicks;
    }

    @Override
    public void xenogenesis$setWallCrawlGraceTicks(int ticks) {
        this.wallCrawlGraceTicks = ticks;
    }

    @Override
    public Vec3 xenogenesis$getCrawlForward() {
        return new Vec3(
    ...
    @Override
    public Vec3 xenogenesis$getOldCrawlForward() {
        return oldCrawlForward;
    }

    @Override
    public Vec3 xenogenesis$getCrawlUp() {
        return new Vec3(
    ...
    @Override
    public Vec3 xenogenesis$getOldCrawlUp() {
        return oldCrawlUp;
    }

    @Override
    public double xenogenesis$getCrawlDistFromBlock() {
        return this.entityData.get(DATA_CRAWL_DIST_FROM_BLOCK);
    }

    @Override
    public double xenogenesis$getOldCrawlDistFromBlock() {
        return oldCrawlDistFromBlock;
    }

    @Override
    public void xenogenesis$setCrawlOrientation(Vec3 forward, Vec3 up, double distFromBlock) {
    ...
    private void syncOldCrawlRenderState() {
        this.oldCrawlForward = this.xenogenesis$getCrawlForward();
        this.oldCrawlUp = this.xenogenesis$getCrawlUp();
        this.oldCrawlDistFromBlock = this.xenogenesis$getCrawlDistFromBlock();
    }
