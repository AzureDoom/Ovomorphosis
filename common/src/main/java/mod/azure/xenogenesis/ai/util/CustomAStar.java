 ...
 * {@link #heuristic}, and {@link #movementCost} to add specialised movement (e.g. wall-crawling — see
...
public class CustomAStar {
    ...
    /**
     * Returns the walkable neighbour positions reachable from {@code pos} for a ground-walking mob. Considers one block
     ...
     * @return list of valid neighbour positions the mob can step to
     */
